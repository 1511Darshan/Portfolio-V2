               ...
               <div className="group flex items-center gap-2">
                  ...
                  <div className="bg-card border border-card-border p-4 shadow-2xl">
                    <div className="flex items-center gap-3 mb-2 border-b border-card-border pb-2">
                      ...
                      <span className="text-[9px] font-mono text-muted-foreground tracking-widest uppercase">Age</span>
                    </div>
                    <div className="flex items-baseline gap-2">
                         <span className="text-3xl font-bold text-foreground tracking-tighter">19</span>
                         <span className="text-[8px] text-muted-foreground font-mono">years old</span>
                    </div>
                  </div>
               </div>
              </motion.div>
               ...
               <div className="group flex items-center gap-2 flex-row-reverse">
                  ...
                  <div className="bg-card border border-card-border p-4 shadow-2xl">
                    <div className="flex items-center gap-3 mb-2 border-b border-card-border pb-2">
                      ...
                      <span className="text-[9px] font-mono text-gray-500 tracking-widest uppercase">Problems Solved</span>
                    </div>
                    <div className="flex items-baseline gap-2">
                         <span className="text-3xl font-bold text-foreground tracking-tighter">250+</span>
                         <span className="text-[8px] text-gray-400 font-mono">LEETCODE</span>
                    </div>
                  </div>
               </div>
            </motion.div>
