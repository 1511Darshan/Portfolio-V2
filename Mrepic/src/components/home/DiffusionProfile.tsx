            ...
            <div className="p-px bg-card-border">
              <div className="bg-card p-6">
                <div className="flex items-center gap-4 mb-6 pb-6 border-b border-card-border">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-foreground">Darshan K</h3>
                    <p className="text-xs text-muted-foreground">AI & Data Science Student</p>
                  </div>
                </div>
                ...
                <div className="space-y-4 text-sm">
                  <div className="flex justify-between items-center border-b border-card-border pb-2">
                    ...
                    <span className="text-foreground">AI & Data Science Student</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-card-border pb-2">
